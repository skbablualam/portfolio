        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>DEVOPS</h3>
              <h4>Building Reliable Cloud Infrastructure</h4>
              <p>
                Designing and automating scalable infrastructure using IaC, CI/CD, and containers for reliable, high-availability systems.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              <h3>CLOUD & SRE</h3>
              <h4>Ensuring Reliability & Performance</h4>
              <p>
                Building and optimizing AWS cloud environments for scalable, efficient, highly reliable, and resilient systems.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
